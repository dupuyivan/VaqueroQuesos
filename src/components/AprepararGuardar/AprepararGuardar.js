...
function AprepararGuardar({ isConsulta, idPermiso }) {
  ...
  const handlePreparar = (producto) => (e) => {
    setPedidoSeleccionado({
      ...producto,
      Fecha: convertirFechaHora(producto.Fecha),
    });
  ...
  function convertirFechaHora(fechaHoraStr) {
    ...
    const fechaLegible = `${dia}/${mes}/${año} ${horas}:${minutos}`;
                ...
                <div key={index} className="contenedor-tabla">
                  <div className="contenedor-cliente">
                    <div className="datos">
                      ...
                      <span>Fecha: {convertirFechaHora(Fecha)}</span>
                      {Observacion?.length ? (
                        <span>
                          Observación:{" "}
                          <span className="obsColor">{Observacion}</span>
                        </span>
                      ) : null}
                    </div>
                    <div>
